...
class DSH_AAXVAL_Cycle_Counts < Script
  ...
  def get_channels(stem_format)
    case stem_format
      ...
      when 'LCR'
        3
      when 'LCRS', 'Quad', "ambisonics(1st_order)"
        4
      when '5_0'
        5
      when '5_1', '6_0'
      ...
      when '7_1', '7_1_DTS', '7_1_SDDS'
        8
      when '7_0_2', 'ambisonics(2nd_order)'
        9
      when '7_1_2'
        10  
      when 'ambisonics(3rd_order)'  
        16
      else
